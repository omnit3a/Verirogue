...
void drawHelp(){
	...
	mvprintw(11,0,"q : Drink from lake");
	mvprintw(12,0,"Q : Drink potion");
	mvprintw(13,0,"i : View inventory");
	mvprintw(14,0,", : Pickup item");
	mvprintw(15,0,"d : Drop item");
	mvprintw(16,0,"r : Read scroll");
	mvprintw(17,0,"? : View this screen");
	attroff(A_BOLD);
	refresh();
	getch();
